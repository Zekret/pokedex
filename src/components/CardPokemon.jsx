  ...
  return (
    ...
    >
      <div
        ...
        className="flex flex-col border-transparent border-solid border-[1px] rounded-t-lg"
      >
        <span
          style={{ color: backgroundSelected, padding: "4px 8px 0px" }}
          className="text-end"
        >
          #{pokemon?.id}
        </span>
      ...
      <div
        ...
        className="text-base leading-4 p-4 rounded-b-lg text-center capitalize text-white font-medium"
      >
        {pokemon?.name}
      </div>
    </Link>
